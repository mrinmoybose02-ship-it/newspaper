...
.back-link{text-align:center;margin-top:20px;display:flex;justify-content:center;gap:15px}
...
<div class="wrapper">
    <div class="header">
        <h1><i class="fas fa-user-plus" style="color:var(--green)"></i> নতুন ইউজার তৈরি</h1>
        <p>রোল ও পারমিশন সহ নতুন ইউজার যুক্ত করুন</p>
    </div>
    ...
    <div class="back-link">
        <a href="update_password.php"><i class="fas fa-key"></i> পাসওয়ার্ড রিসেট করুন</a>
